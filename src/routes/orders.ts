...
const OrderSchema = z.object({
  ...
  unit: z.string().nullable().openapi({ example: "67b1a2b3c4d5e6f7a8b9c0d4" }),
  print_type: z.string().nullable().openapi({ example: "67b1a2b3c4d5e6f7a8b9c0d5" }),
...
const CreateOrderSchema = z.object({
  ...
  unit: z.string().optional().openapi({ example: "67b1a2b3c4d5e6f7a8b9c0d4" }),
  print_type: z.string().optional().openapi({ example: "67b1a2b3c4d5e6f7a8b9c0d5" }),
